              ...
              <div class="collapse navbar-collapse" id="topNav">
                  <ul class="navbar-nav">
					...
					<li class="has-child">
                      ...
                      <a href="loaderlogin.php">Login</a></li>
					  <li><a href="loaderregistration.php">Register</a></li>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="cmdmassage">
				...
				<p> This Project is the combined work of team members ( Aashin, Archana, Kavyashree, Harish, Srinivasan. ) </p>
          ...
          <div class="col-md-5">
            <div class="marQueNews">
			  ...
			  <marquee behavior="scroll" direction="up" onmouseover="this.stop();" onmouseout="this.start();" height="250px;" scrollamount="4">
                ...
                <ul id="marquee_1"> 
				<li>
                  <a href="https://en.wikipedia.org/wiki/Vande_Bharat_Express" class="first-link" target="_blank" > 
                  <h3>
				  
"Experience the Pulse of Progress: Vande Bharat - Uniting Journeys, Accelerating Dreams!"<i><img src="assets/images/new_admissions.gif"></i>
				  </h3></a>
				<li>
                  <a href="https://www.goldenchariot.org/" class="first-link" target="_blank" > 
                  <h3>
                    "Embark on a Journey Fit for Royalty: The Golden Chariot Express - Where Luxury Meets Timeless Adventure!"<i><img src="assets/images/new_admissions.gif"></i>
				  </h3></a>
                  </li>
				

				  <li>
                  <a href="https://irctc.com/new-openings.html" class="first-link" target="_blank" > 
                  <h3> "Join the IRCTC Family: Empowering Careers, Crafting Journeys. Discover Opportunities to Drive the Future of Travel and Hospitality with India's Premier Railway Recruitment Drive!"
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-body">
		  ...
		  <p>IRCTC MINI Project by Aashin,Archana,Kavyashree,Srinivasan and Harish</p>
        </div>
      </div>
